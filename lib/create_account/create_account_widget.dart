                                  ...
                                  onPressed: () async {
                                    try {
                                      ...
                                      await FirebaseFirestore.instance
                                          .collection('users')
                                          .doc(_auth.currentUser?.uid).set({'email': emailAddressController!.text});
                                      ...
                                      if (e.code == 'email-already-in-use') {
                                        ...
                                        showSnackbar(context, "Error creating user");
                                      }
                                    }
                                  },
                                  text: 'Create Account',
